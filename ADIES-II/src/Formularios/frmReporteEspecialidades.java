 ...
 * @author moise
 */
public class frmReporteEspecialidades extends javax.swing.JFrame {
    ...
    public void mostrarDatos(){
        model.setRowCount(0);
        String sql_sel = "select m.Especialidad, count(Especialidad) as cantidad\n"
                + "from consulta as c\n"
    ...
    public void generarGrafico(){
        DefaultCategoryDataset dtsc = new DefaultCategoryDataset();
            for(int i=0; i<this.t_especialidades.getRowCount(); i++){
                dtsc.setValue(Integer.parseInt(this.t_especialidades.getValueAt(i, 1).toString()), this.t_especialidades.getValueAt(i, 0).toString(), "");
            }
             
            JFreeChart ch = ChartFactory.createBarChart3D("Gráfico de Consultas por Especialidades", "Especialidades", "Consultas", dtsc, PlotOrientation.VERTICAL, true, true, false);
    ...
    private void initComponents() {
        ...
        t_especialidades = new javax.swing.JTable();
        ...
        jLabel2.setText("Reporte de Consultas por Especialidades");
        ...
        t_especialidades.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(t_especialidades);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReporteEspecialidades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmReporteEspecialidades().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable t_especialidades;
